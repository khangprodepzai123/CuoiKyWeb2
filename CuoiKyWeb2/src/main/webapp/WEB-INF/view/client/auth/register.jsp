...
<head>
    ...
    <title>Đăng ký - CuoiKyWeb2</title>
                            ...
                            <div class="card-body">
                                <form:form method="post" action="/register" modelAttribute="registerUser">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <form:input class="form-control ${not empty errorFirstName ? 'is-invalid' : ''}"
                                                    type="text" placeholder="Họ" path="firstName" />
                                                <label>Họ</label>
                                                ${errorFirstName}
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <form:input class="form-control" type="text" placeholder="Tên" path="lastName" />
                                                <label>Tên</label>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <form:input class="form-control ${not empty errorPassword ? 'is-invalid' : ''}"
                                                    type="password" placeholder="Mật khẩu" path="password" />
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <form:input class="form-control" type="password"
                                                    placeholder="Xác nhận" path="confirmPassword" />
